...
const char* IFTTT_KEY= "ck7x9mcRoA9omPxgNYilef";
const char* IFTTT_EVENT = "OnDroutDetected";
...
void loop() {
  ...
  if (pressed == true) {
    ...
    Serial.print("eeeeeeeeeeee" + BUTTON_COUNTER);
...
void triggerButtonEvent(String eventName)
{
  ...
  if(eventName == IFTTT_EVENT){
    ...
    value_2 = ipStr;
    value_3 = "hh";//String(WiFi.gatewayIP());
  }
  ...
  if (client.connect(IFTTT_URL, httpPort)) {
     client.print(String("GET ") + url + " HTTP/1.1\r\n" +
      ...
      Serial.println("*************1:" + String(IFTTT_URL));
      Serial.println("*************2:" + String(httpPort));
